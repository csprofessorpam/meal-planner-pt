...
router.post('/', async (req, res) => {
    try {
        ...
        res.status(500).json({ error: 'Failed to create daily meal', details: error.message });
    }
});
...
router.put('/:id', async (req, res) => {
    try {
        ...
        res.status(500).json({ error: 'Failed to update daily meal', details: error.message });
    }
});
// Delete a daily meal
router.delete('/:id', async (req, res) => {
    try {
        ...
        res.status(500).json({ error: 'Failed to delete daily meal', details: error.message });
    }
});
